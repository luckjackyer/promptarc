...
PromptArc is an AI image generation platform, not a SaaS dashboard, not a prompt directory, and not a documentation website. Users come for image quality. Images are the product.
...
Every design decision must increase the chance that a user clicks Generate within 10 seconds.

## Reference Positioning

PromptArc should borrow selectively from these references:

- Midjourney, Krea, Freepik, and Ideogram: real image generation product positioning, image quality proof, prompt-to-result immediacy, and strong visual-first discovery.
...
- a PromptBase-style prompt directory;
...
The homepage and generator entry should prove what users can generate, not how many prompts have been collected.

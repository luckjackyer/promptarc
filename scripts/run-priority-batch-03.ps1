...
$jobsPath = Join-Path $repoRoot "content-pipeline\priority-batch-03.jsonl"
$outDir = Join-Path $repoRoot "content-pipeline\generated\priority-batch-03"
$manifestPath = "content-pipeline\priority-batch-03.json"
...
Write-Host "Priority batch 03 generation, publish, thumbnail, and SEO refresh completed."

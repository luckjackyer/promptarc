...
$jobsPath = Join-Path $repoRoot "content-pipeline\priority-batch-04.jsonl"
$outDir = Join-Path $repoRoot "content-pipeline\generated\priority-batch-04"
$manifestPath = "content-pipeline\priority-batch-04.json"
...
Write-Host "Priority batch 04 generation, publish, thumbnail, and SEO refresh completed."

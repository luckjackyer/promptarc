...
const routePattern = env.WORKER_ROUTE || `www.${rootDomain}/api/*`;
...
async function deployWorker() {
  ...
  const metadata = {
    ...
    bindings: [
      ...
      {
        type: "plain_text",
        name: "REQUIRE_LOGIN_FOR_GENERATION",
        text: env.REQUIRE_LOGIN_FOR_GENERATION || "1"
      },
      {
        type: "plain_text",
        name: "ADMIN_BACKEND_ENABLED",
        text: env.ADMIN_BACKEND_ENABLED || "1"
      },
      {
        type: "plain_text",
        name: "ADMIN_TOKEN",

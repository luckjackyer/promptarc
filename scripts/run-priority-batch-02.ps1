...
$jobsPath = Join-Path $repoRoot "content-pipeline\priority-batch-02.jsonl"
$outDir = Join-Path $repoRoot "content-pipeline\generated\priority-batch-02"
$manifestPath = "content-pipeline\priority-batch-02.json"
...
Write-Host "Priority batch 02 generation, publish, thumbnail, and SEO refresh completed."
